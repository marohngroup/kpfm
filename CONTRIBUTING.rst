...
kpfm could always use more documentation, whether as part of the 
official kpfm docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `kpfm` for
local development.

1. Fork_ the `kpfm` repo on GitHub.
