...
if on_rtd:
    ...
    MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.pyplot',
                    ...
                    'scipy.signal.signaltools', 'sklearn',  'numpy.testing',
                    'scipy.signal', 'scipy.linalg', 'scipy.optimize',
                    'scipy.integrate', 'sigutils', 'scipy.fftpack']
...
project = u'kpfm'
copyright = u'2017, Cornell University'
...
version = kpfm.__version__
# The full version, including alpha/beta/rc tags.
release = kpfm.__version__
...
latex_documents = [
  ('index', 'kpfm.tex', u'kpfm Documentation',
   u'Ryan Dwyer', 'manual'),
]
...
man_pages = [
    ('index', 'kpfm', u'kpfm Documentation',
     [u'Ryan Dwyer'], 1)
]
...
texinfo_documents = [
  ('index', 'kpfm', u'kpfm Documentation',
   u'Ryan Dwyer', 'kpfm', 'One line description of project.',
   'Miscellaneous'),
]
